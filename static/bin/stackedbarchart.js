...
(function() {
  var StackedBarChart, gen_stackedbarchart_data,
  ...
  StackedBarChart = (function() {
    ...
    StackedBarChart.prototype.create_svg = function(el, width, height, vpadding, hpadding) {
      if (vpadding == null) {
        vpadding = 0;
      }
      if (hpadding == null) {
    ...
    StackedBarChart.prototype.draw_bottom_axis = function(svg, x) {
    ...
    StackedBarChart.prototype.draw_left_axis = function(svg, y, data) {
      var left_axis;
    ...
    StackedBarChart.prototype.draw_legend = function(svg, data, colorscale) {
    ...
    StackedBarChart.prototype.draw_bars = function(svg, data, x, y, colorscale) {
      var g_groups, rect;
    ...
    StackedBarChart.prototype.draw_horizontal_lines = function(svg, x) {
  ...
  gen_stackedbarchart_data = function() {
    var data, i, j;
    data = [];
    for (i = j = 0; j < 30; i = ++j) {
      data.push({
